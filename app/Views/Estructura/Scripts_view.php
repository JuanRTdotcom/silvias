<!-- Core JS -->
    ...
    <!-- Vendors JS -->
    <script src="<?php echo APP_URL_PUBLIC_ASSETS?>vendor/libs/apex-charts/apexcharts.js"></script>

    <!-- Main JS -->
    <script src="<?php echo APP_URL_PUBLIC_ASSETS?>js/main.js"></script>

    <!-- Page JS -->
    <script src="<?php echo APP_URL_PUBLIC_ASSETS?>js/dashboards-analytics.js"></script>
    <script src="<?php echo APP_URL_PUBLIC_JS. 'jsGeneral.js?' . rand() ?>"></script>
