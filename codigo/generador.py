...
sql = "select * from colas_querys_monkey where cEstado='2' "
...
if total>0:
        ...
        for rec in rs:
                ...
                if time.time() > timeout:
                        sql3="update colas_querys_monkey set vProgreso='"+ str(porcentaje)+"%" +"' where id='"+ str(id) +"'"
        ...
        sql3="update colas_querys_monkey set vProgreso='100%',cEstado='3',vRuta='"+ str(nombre_archivo)  +"' where id='"+ str(id) +"'"
        curColas.execute(sql3)
        connColas.commit()
