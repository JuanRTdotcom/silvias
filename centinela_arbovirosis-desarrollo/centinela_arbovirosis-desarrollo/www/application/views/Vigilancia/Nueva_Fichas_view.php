                ...
                <div class="card-body">
                    <div class="row">
                        <div class="mb-3 col-md-6">
                            ...
                            <select name="mis_paises" id="mis_paises" class="select2 form-select" required onchange="obtenerProvincia(this)" style="text-transform: uppercase;">
                        ...
                        <div class="mb-3 col-md-12 d-none">
                            ...
                            <input type="text" class="form-control" placeholder="" id="direccion" autocomplete="off" required value="-">
                        </div>
                        <div class="col-md-12">
                            ...
                            <div class="col-md-12 row m-0 card_ficha detalle_direccion" style="padding: 20px;">
                                <div class="row p-0 m-0">
                                    ...
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <input type="text" class="form-control" placeholder="" id="d_nro_manzana" autocomplete="off" >
                                    </div>
                                    <div class="mb-3 col-md-6">
                                        <label for="d_lote" class="form-label">Lote</label>
                                        <input type="text" class="form-control" placeholder="" id="d_lote" autocomplete="off" >
                                    </div>
                                    <div class="mb-3 col-md-6">
                                    ...
                                    <div class="mb-3 col-md-12">
                                        ...
                                        <input type="text" class="form-control" placeholder="" id="d_nombre_asociacion" autocomplete="off" >
                                    </div>
                                </div>
                            </div>
                        </div>
