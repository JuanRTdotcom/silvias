                ...
                <div class="card-body">
                    <div class="row">
                        <div class="mb-3 col-md-6">
                            ...
                            <select name="mis_paises" id="mis_paises" class="select2 form-select" required style="text-transform: uppercase;">
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <select name="mis_departamentos" id="mis_departamentos" class="select2 form-select" onchange="obtenerProvincia(this)">
                                ...
                                <?php foreach ($departamentos as $d) { ?>
                                    <option value="<?php echo $d->ubigeo ?>" <?php echo $d->ubigeo == $mi_departamento[0]->ubigeo ? 'selected' : '' ?>><?php echo $d->nombre ?></option>
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <select name="mis_provincias" id="mis_provincias" placeholder="" class="select2 form-select" onchange="obtenerDistrito(this)" id-prov="<?php echo $inf_ficha->provincia ?>">
                                ...
                                <?php foreach ($provincias as $d) { ?>
                                    <option value="<?php echo $d->ubigeo ?>" <?php echo $d->ubigeo == $mi_provincia[0]->ubigeo ? 'selected' : '' ?>><?php echo $d->nombre ?></option>
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <select name="mis_distritos" id="mis_distritos" class="select2 form-select" id-dist="<?php echo $inf_ficha->distrito ?>">
                                ...
                                <?php foreach ($distritos as $d) { ?>
                                    <option value="<?php echo $d->ubigeo ?>" <?php echo $d->ubigeo == $inf_ficha->distrito ? 'selected' : '' ?>><?php echo $d->nombre ?></option>
                        ...
                        <div class="mb-3 col-md-12 d-none">
                            ...
                            <input type="text" class="form-control" placeholder="" id="direccion" autocomplete="off" required value="<?php echo $inf_ficha->direccion ?>" value="-">
                        </div>
                        <div class="col-md-12">
                            ...
                            <div class="col-md-12 row m-0 card_ficha detalle_direccion" style="padding: 20px;">
                                <div class="row p-0 m-0">
                                    ...
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <input type="text" class="form-control" placeholder="" id="d_nro_manzana" autocomplete="off"  value="<?php echo $inf_ficha->direccion_numero_manzana ?>">
                                    </div>
                                    <div class="mb-3 col-md-6">
                                        <label for="d_lote" class="form-label">Lote</label>
                                        <input type="text" class="form-control" placeholder="" id="d_lote" autocomplete="off"  value="<?php echo $inf_ficha->direccion_lote ?>">
                                    </div>
                                    <div class="mb-3 col-md-6">
                                        <label for="d_tipo_asociacion" class="form-label">Tipo asociación</label>
                                        <select name="d_tipo_asociacion" id="d_tipo_asociacion" class="select2 form-select" >
                                    ...
                                    <div class="mb-3 col-md-12">
                                        ...
                                        <input type="text" class="form-control" placeholder="" id="d_nombre_asociacion" autocomplete="off"  value="<?php echo $inf_ficha->direccion_nombre_asociacion ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="mb-3 col-md-12">
                            <label for="diagnostico_captacion" class="form-label">Diagnóstico de captación</label>
